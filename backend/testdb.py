...
with app.app_context():
    ...
    # Create questions
    questions = [
        Questions(question="What is 2+2?", option1="3", option2="4", option3="5", option4="22", answer=2, subject_id=subjects[0].id),
        Questions(question="Solve 2x=10", option1="4", option2="5", option3="6", option4="7", answer=2, subject_id=subjects[0].id),
        Questions(question="What is Newton's second law?", option1="F=ma", option2="E=mc^2", option3="a^2+b^2=c^2", option4="V=IR", answer=1, subject_id=subjects[1].id),
        Questions(question="What is the speed of light?", option1="3x10^8 m/s", option2="1x10^8 m/s", option3="2x10^8 m/s", option4="5x10^8 m/s", answer=1, subject_id=subjects[1].id),
        Questions(question="Which data structure is LIFO?", option1="Queue", option2="Stack", option3="Heap", option4="Linked List", answer=2, subject_id=subjects[2].id),
        Questions(question="What is the time complexity of binary search?", option1="O(n)", option2="O(n log n)", option3="O(log n)", option4="O(1)", answer=3, subject_id=subjects[2].id),
    ]
    ...
    user_subjects = [
        User_Subject(subject_id=subjects[0].id, user_id=users[0].id),
        User_Subject(subject_id=subjects[0].id, user_id=users[1].id),
        User_Subject(subject_id=subjects[1].id, user_id=users[2].id),
        User_Subject(subject_id=subjects[2].id, user_id=users[3].id),
        User_Subject(subject_id=subjects[2].id, user_id=users[4].id),
    ]
    db.session.add_all(user_subjects)

    # Map questions to quizzes
    question_quizzes = [
        Question_Quiz(quiz_id=quizzes[0].id, question_id=questions[0].id),
        Question_Quiz(quiz_id=quizzes[0].id, question_id=questions[1].id),
        Question_Quiz(quiz_id=quizzes[2].id, question_id=questions[2].id),
        Question_Quiz(quiz_id=quizzes[2].id, question_id=questions[3].id),
        Question_Quiz(quiz_id=quizzes[4].id, question_id=questions[4].id),
        Question_Quiz(quiz_id=quizzes[5].id, question_id=questions[5].id),
    ]
    db.session.add_all(question_quizzes)
