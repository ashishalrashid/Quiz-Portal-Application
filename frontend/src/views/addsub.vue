<template>
  <div class="page">
    <aside class="sidebar" aria-label="Admin dashboard navigation">
      ...
      <!-- keep logout handler as-is (method not added/changed) -->
    ...
    <main class="main">
      <section class="form-card" aria-labelledby="create-subject-heading">
        <h2 id="create-subject-heading" class="heading">Create Subject</h2>
    ...
    async NewSub() {
      ...
      try {
        ...
        const response = await axios.post(
          "http://localhost:5000/createsubject",
          {
            name: this.Sub_name,
