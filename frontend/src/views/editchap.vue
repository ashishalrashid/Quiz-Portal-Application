<template>
  <div class="page">
    ...
    <main class="main" role="main">
      <section class="card" aria-labelledby="edit-chapter-heading">
        <h2 id="edit-chapter-heading" class="heading">Edit Chapter</h2>

        <form @submit.prevent="updateChapter" class="form" novalidate>
          ...
          <div class="actions">
            ...
            <router-link :to="`/admindash/subject/${$route.params.subject_id || ''}`" class="btn-secondary">Cancel</router-link>
          </div>
        </form>
      </section>
    </main>
